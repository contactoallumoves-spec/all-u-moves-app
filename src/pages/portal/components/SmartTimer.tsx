...
export function SmartTimer({ autoStartDuration = 90, isVisible, onClose }: SmartTimerProps) {
    ...
    return (
        <div className="fixed bottom-20 right-4 left-4 md:left-auto md:w-80 bg-zinc-900 border border-zinc-800 text-white p-4 rounded-2xl shadow-2xl z-50 flex items-center justify-between transition-all duration-300">
