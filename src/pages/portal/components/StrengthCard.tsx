...
export function StrengthCard({ exercise, sessionId, onSetComplete }: StrengthCardProps) {
    ...
    // Parse "Ghost Data" (Last week) - Placeholder for now
    const ghostData = "3x10 @ 15kg"; // TODO: Fetch real history
    ...
    const rows = Array.from({ length: prescribedSets }).map((_, i) => {
        ...
        // Smart Default: If empty, maybe pre-fill with prescription? 
        // For V1, keep empty.
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-between items-center px-2">
                ...
                <button className="text-[10px] bg-brand-50 text-brand-600 px-2 py-1 rounded-md font-bold uppercase hover:bg-brand-100 transition">
                    Repetir Carga
                </button>
            </div>
